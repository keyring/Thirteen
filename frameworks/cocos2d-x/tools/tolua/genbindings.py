...
def main():
    ...
    try:
        ...
        cmd_args = {
                    ...
                    # 'cocos2dx_ios_share.ini' : ('cocos2dx_ios_share', 'lua_cocos2dx_ios_share_auto'), \
                    # 'cocos2dx_ios_gamecenter.ini' : ('cocos2dx_ios_gamecenter', 'lua_cocos2dx_ios_gamecenter_auto'), \
                    'cocos2dx_connect.ini' : ('cocos2dx_connect', 'lua_cocos2dx_connect_auto'), \
                    }
        target = 'lua'
